...
def forwarding(src):
	...
	global m_valE
	global m_valM
	if(((e_icode=="2") or (e_icode=="3") or (e_icode=="6") or (e_icode=="8") or (e_icode=="9") or (e_icode=="a")) and (e_dstE==src)):
			return e_valE
	...
	if(((m_icode=="2") or (m_icode=="3") or (m_icode=="6") or (m_icode=="8") or (m_icode=="9") or (m_icode=="a")) and (m_dstE==src)):
			return m_valE
